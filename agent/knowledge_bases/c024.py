...
AMAN HMO CORPORATE PLAN C024 BENEFITS - 2026 KNOWLEDGE BASE
Today's date: {today}
Source document: C024.pdf
Source title: Vento Basic Custom Plan
...
Maximum Annual Benefit:
  NOT STATED in the C024 source PDF. Do not invent an annual master cap. Use explicit benefit bucket limits and AMAN consumption data where available.
...
HIV/AIDS Care and Treatment:
  Referral to accredited center. No monetary sublimit is stated in the C024 source PDF.
...
NOTE: Exclusions override the surgery classification. Joint replacements and prosthetic limbs are listed as exclusions in this C024 source.

------------------------------------------
MATERNITY, NEONATAL & IMMUNIZATIONS
------------------------------------------
C024 lists maternity benefits but does not state the family-plan-or-50-principals eligibility rule. If subscriber/dependent eligibility for maternity or neonatal care is unclear from the payload, ESCALATE rather than approve or deny solely on plan tier.
...
SPECIAL RULES
------------------------------------------
1. BASIC CUSTOM PLAN ONLY: C024 has only the Basic plan tier.
...
4. AGE LIMIT: Age limit on C024 plan is 60 years.
5. FAMILY PREMIUM: Family premium quoted is for family of six (principal, spouse, and 4 children under 18).
...
------------------------------------------
EXCLUSIONS - ALWAYS DENY (C024 BASIC CUSTOM PLAN)
------------------------------------------
